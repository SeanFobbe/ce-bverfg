#'---
#'title: "Codebook | Corpus der Entscheidungen des Bundesverfassungsgerichts"
#'author: Seán Fobbe
#'geometry: margin=3cm
#'papersize: a4
#'fontsize: 11pt
...
#'      before_body: [CE-BVerfG_Source_TEX_Definitions.tex,CE-BVerfG_Source_TEX_CodebookTitle.tex]
...
#' CSV\_Annotiert & \textbf{Legal Tech/Quantitative Forschung}. Alle Entscheidungenn in tokenisierter Form mit linguistischen Annotationen. Beachten Sie bitte die besondere Variablen-Struktur unter Punkt \ref{annovars}.  Jede Spalte entspricht einer Variable, jede Zeile einem Token.\\
#' CSV\_Metadaten & \textbf{Legal Tech/Quantitative Forschung}. Wie die andere CSV-Datei, nur ohne die Entscheidungstexte. Sinnvoll für Analyst:innen, die sich nur für die Metadaten interessieren und Speicherplatz sparen wollen.  Jede Spalte entspricht einer Variable, jede Zeile einer Entscheidung.\\
