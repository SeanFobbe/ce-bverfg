...
```{r, CE-BVerfG_00_Pipeline_Graph_dark-blue, fig.width = 12, fig.height = 14, fig.pos = "p", fig.cap = "Der vollständige Prozess der Datensatz-Kompilierung."}
...
```{r, CE-BVerfG_00_Pipeline_Graph_dark-green, fig.width = 12, fig.height = 14, fig.pos = "p", fig.cap = "Der vollständige Prozess der Datensatz-Kompilierung."}
