...
Der Datensatz enthält zusätzlich eine spezialisierte Variante, die Zitate des BVerfG aus den Entscheidungstexten zu seiner eigenen Rechtsprechung extrahiert und in strukturierter Form aufbereitet. Diese Variante ist noch in der Beta-Testphase, wertet aber bereits folgende Zitate aus:
