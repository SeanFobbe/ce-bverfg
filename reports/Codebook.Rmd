...
```{r, CE-BVerfG_Zitationsnetzwerk_Sugiyama_schwarz, fig.width = 40, fig.height = 50, fig.dpi = 50, fig.pos = "p", fig.cap = "Das Zitationsnetzwerk des BVerfG ab 1997", dev = "png"}
