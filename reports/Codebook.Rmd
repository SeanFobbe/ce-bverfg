...
```{r, CE-BVerfG_00_Pipeline_Graph, fig.width = 12, fig.height = 14, fig.pos = "p", fig.cap = "Der vollständige Prozess der Datensatz-Kompilierung."}
...
# Internes Zitationsnetzwerk des Bundesverfassungsgerichts (Beta)
...
ggplot(data = degree.all) +
    ...
    labs(
        title = paste(prefix.figuretitle,
                      "| Verteilung der Knotengrade im Zitationsnetzwerk"),
        caption = caption,
        x = "Knotengrad",
        y = "Anteil"
    )+
...
ggplot(data = degree.in) +
    ...
    labs(
        title = paste(prefix.figuretitle,
                      "| Verteilung der Eingangsgrade im Zitationsnetzwerk"),
        caption = caption,
        x = "Eingangsgrad",
        y = "Anteil"
    )+
