...
- Es werden nur PDF- und HTML-Dateien abgerufen (\emph{file type bias}). Manche Entscheidungen sind nur als HTML verfügbar. Die Metadaten der Entscheidungen ohne PDF-Datei werden explizit im Compilation Report dokumentiert.
...
```{r, CE-BVerfG_03_Barplot_Spruchkoerper_Typ, fig.height = 6, fig.width = 9}
...
```{r, CE-BVerfG_06_Barplot_Spruchkoerper_AZ, fig.height = 6, fig.width = 9}
...
freqtable.db <- f.fast.freqtable(dt.bverfg.meta,
...
```{r, CE-BVerfG_07_Barplot_Spruchkoerper_DB, fig.height = 12, fig.width = 8}
...
freqtable.regz <- f.fast.freqtable(dt.bverfg.meta,
...
```{r, CE-BVerfG_08_Barplot_Registerzeichen, fig.height = 14, fig.width = 10}
...
freqtable.praesi <- f.fast.freqtable(dt.bverfg.meta,
                                 varlist = "praesi",
                                 sumrow = TRUE,
                                 output.list = TRUE,
                                 output.kable = FALSE,
...
freqtable.vpraesi <- f.fast.freqtable(dt.bverfg.meta,
                                 varlist = "v_praesi",
                                 sumrow = TRUE,
                                 output.list = TRUE,
                                 output.kable = FALSE,
...
freqtable.entscheidungsjahr <- f.fast.freqtable(dt.bverfg.meta,
...
```{r}
freqtable.eingangsjahr <- f.fast.freqtable(dt.bverfg.meta,
